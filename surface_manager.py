...
class surface_manager:
	def __init__(self, material_manager,run_id):
		...
		# self.surface_data_path = '/home/chroma/chroma_fresh_start/results/data/Sebastian_FS_06.08.2023_correctedSiPM/surface_props__Sebastian_teflon_FS_0608_corrected.csv'
		# self.surface_data_path = '/home/chroma/chroma_fresh_start/results/data/Sebastian_03.31.2023(liquefaction_corrrectedSiPM)/surface_props__Sebastian_03312023_corrected.csv'
		# self.surface_data_path = '/home/chroma/chroma_fresh_start/results/data/Sebastian_05.18.2023(liquefaction)_correctedSiPM/surface_props__Sebastian_teflon_0518_corrected.csv'
		# self.surface_data_path = '/home/chroma/chroma_fresh_start/results/data/Sebastian_07.20.2022(liquefaction)_corrrectedSiPM/surface_props__Sebastian_07202022_corrected.csv'
		self.surface_data_path = '/home/chroma/chroma_fresh_start/results/data/Sebastian_08.01.2023(liquefaction)_correctedSiPM/surface_props__Sebastian_Pdreflector_0801_corrected.csv'

		self.SiPMAOIref_path = '/home/chroma/chroma_fresh_start/data_files/FBK.csv'
		# self.SiPMAOIref_path = '/home/chroma/chroma_fresh_start/data_files/FBK reflectivity_upper_bound.csv'
		# self.SiPMAOIref_path ='/home/chroma/chroma_fresh_start/data_files/FBK reflectivity_lower_bound.csv'
		# self.SiPMAOIref_path = '/home/chroma/chroma_fresh_start/data_files/FBK _origin.csv'
		self.run_id = run_id
		# filename = '/home/chroma/chroma_fresh_start/results/data/Sebastian_FS_06.08.2023_correctedSiPM/datapoints/copper_spec_coefficient' + str(self.run_id) + '.csv'
		...
		self.savedata_path = '/home/chroma/chroma_fresh_start/results/data/Sebastian_FS_06.08.2023_correctedSiPM/datapoints/Cu_spec_Cu_eta.csv'
		self.build_surfaces()
