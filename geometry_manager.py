...
class geometry_manager:
    def __init__(self,run_id,visualize = False):
        ...
        # self.geometry_data_path = '/home/chroma/chroma_fresh_start/results/data/Sebastian_woteflon_geom_07.22.2022/geometry_components __Sebastian_woteflon_0722_2022.csv'
        # self.geometry_data_path = '/home/chroma/chroma_fresh_start/results/data/Sebastian_FS_06.08.2023_correctedSiPM/geometry_components __Sebastian_teflon__FS_0608_corrected.csv'
        # self.geometry_data_path = '/home/chroma/chroma_fresh_start/results/data/Sebastian_03.31.2023(liquefaction_corrrectedSiPM)/geometry_components __Sebastian_03312023_corrected.csv'
        # self.geometry_data_path ='/home/chroma/chroma_fresh_start/results/data/Sebastian_05.18.2023(liquefaction)_correctedSiPM/geometry_components __Sebastian_teflon__0518_corrected.csv'
        # self.geometry_data_path ='/home/chroma/chroma_fresh_start/results/data/Sebastian_07.20.2022(liquefaction)_corrrectedSiPM/geometry_components __Sebastian_07202022_corrected.csv'
        self.geometry_data_path = '/home/chroma/chroma_fresh_start/results/data/Sebastian_08.01.2023(liquefaction)_correctedSiPM/geometry_components __Sebastian_Pdreflector__0801_corrected.csv'
        # self.geometry_data_path = '/home/chroma/chroma_fresh_start/results/data/Sebastian_FS_06.08.2023_correctedSiPM/geometry_components __Sebastian_teflon__FS_0608_corrected (FusionTest).csv'
        self.build_geometry()
