...
#show: project.with(
  title: [Chroma Simulation \ 8Silicon35\_87 \ newsurface],
...
#table(
  columns: 9,
  [name], [outer_mat], [inner_mat], [model_id], [reflect_specular], [reflect_diffuse], [reflect_lobed], [backscatter], [sigma_alpha],
  [FBK HD3], [liquid xenon], [silicon], [5], [0], [0], [0], [0], [0.0],
  [Cu-Xe], [liquid xenon], [copper], [8], [0], [1], [0], [0], [0.0],
  [silicon-Xe], [liquid xenon], [silicon], [6], [0], [0], [1], [0], [0.2],
  [killing surface], [None], [None], [8], [0], [0], [0], [0], [0.0],
)
