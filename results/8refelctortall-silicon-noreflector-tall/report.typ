...
#show: project.with(
  title: [Chroma Simulation \ 8refelctortall \ silicon-noreflector-tall],
...
- Random Seed: 1042
- Run ID: 1
- Excluded Geometry: ['reflector1', 'reflector3', 'reflector5', 'reflector7', 'reflector2', 'reflector4', 'reflector6', 'reflector8']
- PTE: 0.0013 $plus.minus$ 0.0000.
